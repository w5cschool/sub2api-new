...
“我们”“本公司”和/或“我们的”是指 ${operatorName} 及 tocodex.space。

“网站”是指域名为 tocodex.space 的网站，包括所有子域名。
...
此外，您不得以第三方服务使用政策所禁止的任何目的或方式使用 tocodex.space。我们保留因您违反任何禁止用途或其他任何原因而自行决定终止您使用网站和/或服务的权利。
...
本协议仅为您访问和使用网站和/或服务的协议，本条款与条件并未授予您任何软件许可。网站和服务受新加坡以及适用情况下的国际知识产权法律保护。网站和服务属于我们，且为我们或我们的许可方所有。我们保留网站和服务的全部所有权。
...
本条款应受新加坡法律管辖并据其解释，不考虑其法律冲突规则。

### 8.2 仲裁

双方同意，任何涉及、关联或指向本条款和/或网站和/或服务的争议，均应根据新加坡实体法律通过具有约束力的仲裁方式专属解决。
...
我们在全球范围内运营，因此有必要在国际范围内传输您的信息。特别是，您的信息很可能会被传输至新加坡的服务器并在该地处理。使用网站和/或服务即表示您同意您的信息按照隐私政策所述方式被收集、使用和传输。
...
本条款的生效日期为 **2023 年 11 月 14 日**。我们可能会不时更新本条款与条件，因此建议您经常查看。`,
  },
  {
    id: 'privacy-policy',
    title: '隐私政策',
