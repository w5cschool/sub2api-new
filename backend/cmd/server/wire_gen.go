...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	subscriptionRecordRepository := repository.NewSubscriptionRecordRepository(client)
	subscriptionService := service.NewSubscriptionService(groupRepository, userSubscriptionRepository, subscriptionRecordRepository, billingCacheService, client, configConfig)
	...
	teamService := service.NewTeamService(teamRepository, userRepository, usageLogRepository)
	teamHandler := handler.NewTeamHandler(teamService, usageService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, adminTeamHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
