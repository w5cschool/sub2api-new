...
func (e UserSubscriptionEdges) SubscriptionRecordsOrErr() ([]*SubscriptionRecord, error) {
	if e.loadedTypes[3] {
...
// QuerySubscriptionRecords queries the "subscription_records" edge of the UserSubscription entity.
func (_m *UserSubscription) QuerySubscriptionRecords() *SubscriptionRecordQuery {
	return NewUserSubscriptionClient(_m.config).QuerySubscriptionRecords(_m)
}
