...
type UserEdges struct {
	...
	// AssignedSubscriptionRecords holds the value of the assigned_subscription_records edge.
	AssignedSubscriptionRecords []*SubscriptionRecord `json:"assigned_subscription_records,omitempty"`
...
// was not loaded in eager-loading.
func (e UserEdges) SubscriptionRecordsOrErr() ([]*SubscriptionRecord, error) {
	if e.loadedTypes[4] {
...
// AssignedSubscriptionRecordsOrErr returns the AssignedSubscriptionRecords value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) AssignedSubscriptionRecordsOrErr() ([]*SubscriptionRecord, error) {
	if e.loadedTypes[5] {
		return e.AssignedSubscriptionRecords, nil
	}
	return nil, &NotLoadedError{edge: "assigned_subscription_records"}
}
...
// QuerySubscriptionRecords queries the "subscription_records" edge of the User entity.
func (_m *User) QuerySubscriptionRecords() *SubscriptionRecordQuery {
	return NewUserClient(_m.config).QuerySubscriptionRecords(_m)
}

// QueryAssignedSubscriptionRecords queries the "assigned_subscription_records" edge of the User entity.
func (_m *User) QueryAssignedSubscriptionRecords() *SubscriptionRecordQuery {
	return NewUserClient(_m.config).QueryAssignedSubscriptionRecords(_m)
}
