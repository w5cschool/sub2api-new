...
func init() {
	...
	// groupDescDefaultPriceUsd is the schema descriptor for default_price_usd field.
	groupDescDefaultPriceUsd := groupFields[16].Descriptor()
	// group.DefaultDefaultPriceUsd holds the default value on creation for the default_price_usd field.
	group.DefaultDefaultPriceUsd = groupDescDefaultPriceUsd.Default.(float64)
	...
	subscriptionrecordMixin := schema.SubscriptionRecord{}.Mixin()
	subscriptionrecordMixinFields0 := subscriptionrecordMixin[0].Fields()
	_ = subscriptionrecordMixinFields0
	subscriptionrecordFields := schema.SubscriptionRecord{}.Fields()
	_ = subscriptionrecordFields
	// subscriptionrecordDescCreatedAt is the schema descriptor for created_at field.
	subscriptionrecordDescCreatedAt := subscriptionrecordMixinFields0[0].Descriptor()
	// subscriptionrecord.DefaultCreatedAt holds the default value on creation for the created_at field.
	subscriptionrecord.DefaultCreatedAt = subscriptionrecordDescCreatedAt.Default.(func() time.Time)
	// subscriptionrecordDescUpdatedAt is the schema descriptor for updated_at field.
	subscriptionrecordDescUpdatedAt := subscriptionrecordMixinFields0[1].Descriptor()
	// subscriptionrecord.DefaultUpdatedAt holds the default value on creation for the updated_at field.
